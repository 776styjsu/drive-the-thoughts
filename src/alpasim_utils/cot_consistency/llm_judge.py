...
# Moonshot AI's public OpenAI-compatible API (Kimi K2.5). The paper's Kimi
# runs went through a university gateway that outside users cannot reach; the
# public endpoint keeps reruns reproducible anywhere, and any other
# OpenAI-compatible host (e.g. OpenRouter model ``moonshotai/kimi-k2.5``)
# works via the base_url/model/api_key overrides.
